...
public final class Config
{
	...
	public static int CRAFT_MASTERWORK_PREMIUM;
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			CRAFT_MASTERWORK_PREMIUM = Character.getInt("CraftMasterworkPremium", 4);
	...
	public static boolean setParameterValue(String pName, String pValue)
	{
		switch (pName.trim().toLowerCase())
		{
			...
			case "craftmasterworkpremium":
				CRAFT_MASTERWORK_PREMIUM = Integer.parseInt(pValue);
				break;
